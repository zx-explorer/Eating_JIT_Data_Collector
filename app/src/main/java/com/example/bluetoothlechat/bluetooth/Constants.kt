 ...
 */
val SERVICE_UUID: UUID = UUID.fromString("40af0001-9479-43f6-ae95-c45fb2afb9d2")
...
/**
 * UUID for write to the ble device
 */
val WRITE_UUID: UUID = UUID.fromString("40af0002-9479-43f6-ae95-c45fb2afb9d2")

/**
 * UUID for read from the ble device
 */
val READ_UUID: UUID = UUID.fromString("40af0003-9479-43f6-ae95-c45fb2afb9d2")
